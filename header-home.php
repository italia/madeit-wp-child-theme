...
<div class="it-header-wrapper it-header-sticky" >
    ...
    <div class="it-nav-wrapper"  data-aos="fade-down" data-aos-duration="1500" data-aos-delay="1000">
        <div class="it-header-center-wrapper d-lg-none">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="it-header-center-content-wrapper ">
                            <div class="it-brand-wrapper">
                                <a href="<?php echo home_url(); ?>">
                                    <img class="d-none icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-repubblica-italiana.svg" alt="Emblema della Repubblica Italiana">
